...
public class RefStateProvinceComponent {
	...
	public TxnTransferObj findAllRecordsByLanguageCode(TxnTransferObj txnTransferObj) {
		...
		try {
			...
			Page<RefStateProvinceDO> pageRefStateProvinceDO = findAllRecordsByLanguageCodeFromRepository(
					...
					txnTransferObj.getTxnPayload().getRefStateProvinceDO().getCountryIsoRefkey(),
	...
	public Page<RefStateProvinceDO> findAllRecordsByLanguageCodeFromRepository(@CacheKey String configLanguageCodeKey,@CacheKey String countryIsoRefkey, 
		...
		if (filter.toUpperCase().equals("ACTIVE")) {
			pageRefStateProvinceDO = this.theRefStateProvinceRepository
					.findAllActiveByLanguageCodeAndCountry(configLanguageCodeKey, countryIsoRefkey, localPageable);
		} else if (filter.toUpperCase().equals("INACTIVE")) {
			pageRefStateProvinceDO = this.theRefStateProvinceRepository
					.findAllInActiveByLanguageCodeAndCountry(configLanguageCodeKey,countryIsoRefkey, localPageable);
		} else if (filter.toUpperCase().equals("ALL")) {
			pageRefStateProvinceDO = this.theRefStateProvinceRepository.findAllByLanguageCodeAndCountry(configLanguageCodeKey,countryIsoRefkey,
					localPageable);
