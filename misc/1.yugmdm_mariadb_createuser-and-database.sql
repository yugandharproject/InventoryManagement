...
CREATE USER 'INV_OWNER'@'%' IDENTIFIED BY 'INV_OWNER';
GRANT EXECUTE, PROCESS, SELECT, SHOW DATABASES, SHOW VIEW, ALTER, ALTER ROUTINE, CREATE, CREATE ROUTINE, CREATE TABLESPACE, CREATE TEMPORARY TABLES, CREATE VIEW, DELETE, DROP, EVENT, INDEX, INSERT, REFERENCES, TRIGGER, UPDATE, CREATE USER, FILE, LOCK TABLES, RELOAD, REPLICATION CLIENT, REPLICATION SLAVE  ON *.* TO 'INV_OWNER'@'%' WITH GRANT OPTION;
FLUSH PRIVILEGES;
...
-- Dumping data for table INVENTORYDB.address: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.al_address: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.al_config_txn_registry: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.al_legalentity: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.al_le_address_assoc: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.al_le_person: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.al_le_phone_assoc: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.al_personnames: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.al_ref_gender: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.al_ref_state_province: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.config_txn_registry: ~451 rows (approximately)
...
-- Dumping data for table INVENTORYDB.legalentity: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.le_address_assoc: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.le_person: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.le_phone_assoc: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.personnames: ~0 rows (approximately)
...
-- Dumping data for table INVENTORYDB.ref_gender: ~5 rows (approximately)
...
-- Dumping data for table INVENTORYDB.ref_language_code: ~1 rows (approximately)
...
-- Dumping data for table INVENTORYDB.ref_state_province: ~65 rows (approximately)
