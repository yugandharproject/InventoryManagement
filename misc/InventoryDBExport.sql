...
-- Dumping data for table inventorydb.al_personnames: ~20 rows (approximately)
...
-- Dumping data for table inventorydb.al_ref_state_province: ~127 rows (approximately)
...
-- Dumping data for table inventorydb.config_txn_registry: ~459 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `inventory_product` (
  ...
  `HSN-SAC Code` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
-- Dumping data for table inventorydb.inventory_product: ~3 rows (approximately)
/*!40000 ALTER TABLE `inventory_product` DISABLE KEYS */;
INSERT INTO `inventory_product` (`ID_PK`, `VERSION`, `CREATED_TS`, `DELETED_TS`, `UPDATED_TS`, `UPDATED_BY_USER`, `UPDATED_BY_TXN_ID`, `PRODUCT_ID`, `Supplier_ID`, `Product_Name`, `Product_Type`, `Product_Category`, `HSN-SAC Code`, `Product_Status`, `Product_Expiry_Date`, `Product_Arrival_Date`, `Quantity_Recevied`, `Quantity_Inhand`, `Quantity_UnitOfMeasure`, `Bill_number`) VALUES
	...
	('15655069684138642', 0, '2019-08-11 12:32:48.412000', NULL, '2019-08-11 12:32:48.412000', 'admin', '156550696826336456', '123123', '123123123', 'Pencil', '', 'Stationary', '', '', NULL, NULL, 1, NULL, '2', ''),
...
-- Dumping data for table inventorydb.ref_unitofmeasure: ~5 rows (approximately)
...
INSERT INTO `yug_registry_seq` (`next_not_cached_value`, `minimum_value`, `maximum_value`, `start_value`, `increment`, `cache_size`, `cycle_option`, `cycle_count`) VALUES
	(101000, 1, 1000000, 100000, 1, 1000, 0, 0);
